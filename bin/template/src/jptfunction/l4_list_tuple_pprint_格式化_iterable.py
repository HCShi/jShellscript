...
print(list(range(10))[5:])  # [5, 6, 7, 8, 9]; 从第 6 个开始
print(list(range(10))[:5])  # [0, 1, 2, 3, 4]; 取到第 5 个
print(list(range(10))[5:][:2])  # [5, 6]; 从第 6 个开始取两个
...
##################################################################
## 做题目中不要轻易用 list
a = [[0, 0], [0, 0]]; print(a)  # [[0, 0], [0, 0]]
a[0][1] = 1; print(a)  # [[0, 1], [0, 0]]
# 使用 * 会形成指针
a = [[0, 0]] * 2; print(a)  # [[0, 0], [0, 0]]
a[0][1] = 1; print(a)  # [[0, 1], [0, 1]]; 就然第二行也变了
##################################################################
## index(), count()
