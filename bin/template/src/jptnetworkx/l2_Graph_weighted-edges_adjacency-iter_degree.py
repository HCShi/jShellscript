...
##################################################################
# degree()
print(nx.degree(FG), FG.degree())  # {1: 2, 2: 2, 3: 2, 4: 2}; 只统计个数, 两种写法一样
print(nx.degree(FG, weight='weight'), FG.degree(weight='weight'))  # {1: 0.875, 2: 1.325, 3: 1.125, 4: 1.575}; 统计属性, 两种写法一样
